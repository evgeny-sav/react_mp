...
app.get('/api/v1/movies', (req, res) => {
  res.json([
    ...
    },
    {
      ...
      'printer took a galley of type and scrambled it to make a type specimen book. It has survived' +
      ' not only five centuries',
      image_url: 'http://media.comicbook.com/2017/06/the-batman-movie-fan-poster-ben-affleck-1000887.png',
    },
    {
      id: 3,
      title: 'StarWars',
      ...
      'printer took a galley of type and scrambled it to make a type specimen book. It has survived' +
      ' not only five centuries',
      image_url: 'https://images.moviepilot.com/images/' +
      'c_limit,q_auto:good,w_600/fphwgmpl5aanu4togqqa/original-star-wars-poster-the-force-awakens-style.jpg',
    },
    {
      id: 4,
      title: 'Thor',
